...
from distribution_statistics import Distribution_statistics
...
class Rightcontent(QWidget):
    def __init__(self):
        ...
        ####堆叠布局之组件预览
        self.stacklayout_web_view = Web_view()
        
        
        ####堆叠布局之后台管理
        self.stacklayout_distribution_statistics= Distribution_statistics()
        ...
        self.rightstack_layout.addWidget(self.stacklayout_distribution_statistics.layout_QV_group)
        self.rightstack_layout.addWidget(self.stacklayout_web_view.layout_QV_group)
