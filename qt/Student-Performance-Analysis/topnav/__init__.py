...
#         self.topnav_group.setStyleSheet("background-color:{};border-radius:10px;".format(static.data["topnav"]["bg"]))
#         #self.topnav_group.setFixedWidth(800)
#         self.topnav_group.setFixedHeight(60)
#         self.topnav_layout = QHBoxLayout()


#         #导航栏标签
#         self.currentpagelabel = QLabel(static.data["currentpagelabel"]["label"])
#         self.currentpagelabel.setContentsMargins(30,0,0,0)
#         self.currentpagelabel.setStyleSheet("color:{};background-color:rgba(48,55,100,0);font: bold;font-size:14px;".format(static.data["currentpagelabel"]["color"]))
#         self.topnav_layout.addWidget(self.currentpagelabel)
#         self.topnav_layout.addStretch()
        
        
#         #导航栏右侧 最小化
#         self.topnav_tomin = miniQlabel("—")
